...
else 
{
   if (validatePayment($_GET['paycode'],$_GET['payline'] )== true ) {
		...
		$sqlInsertAccount = $db->query("INSERT INTO accesscode (ip,code,time) VALUES ('".$_SERVER['REMOTE_ADDR']."','".$_GET['paycode']."','".time()."')");
